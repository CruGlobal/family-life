...
describe('transformRegistrant', () => {
  ...
  describe('event fields', () => {
    it('maps event fields from conference', () => {
      ...
      expect(record.Event_Start_Date__c).toBe('2026-03-15T18:00:00')
      expect(record.Event_End_Date__c).toBe('2026-03-17T12:00:00')
  ...
  describe('date fields', () => {
    it('maps registration dates', () => {
      ...
      expect(record.Involvement_Registration_Created_Date__c).toBe('2026-02-05T12:00:00Z')
    })
  })
